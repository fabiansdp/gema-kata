            ...
            <div className="flex">
                {
                    isLoading?
                        <div className="h-screen flex justify-center items-center mx-auto">
                            ...
                            <div className="h-screen flex flex-col justify-center items-start mx-auto">
                                <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[327px] gap-[35px]" >
